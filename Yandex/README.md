...
> [!NOTE]  
> Сферы деятельности компаний: $${\color{gold}Интернет-сервисы}$$ $${\color{green}Стриминговый сервис}$$

> [!TIP]
> Направление деятельности: $${\color{red}Data Analyst}$$

> [!IMPORTANT]  
> Навыки и инструменты: $${\color{red}Python}$$ $${\color{green}Pandas}$$
